...
const Login = () => {
  ...
  return (
    <div
      ...
      className="fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center text-sm text-slate-300 bg-black/50"
    >
      <form
        ...
        {state === "register" && (
          <div className="w-full">
            ...
            <input
              ...
              className="border border-slate-700 rounded w-full p-2 mt-1 outline-primary"
              type="text"
              required
            />
          </div>
